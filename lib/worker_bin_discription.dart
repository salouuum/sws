...
class WorkerBin_Discription extends StatefulWidget {
  WorkerBin_Discription({
required Bin bin
});
  @override
  State<WorkerBin_Discription> createState() => _WorkerBin_DiscriptionState();
}

class _WorkerBin_DiscriptionState extends State<WorkerBin_Discription> {
